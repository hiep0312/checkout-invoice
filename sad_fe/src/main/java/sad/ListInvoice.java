 ...
 * @author hiepd
 */
public class ListInvoice extends javax.swing.JFrame {
    ...
    public ListInvoice(List<Invoice> invoices) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListInvoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListInvoice().setVisible(true);
            }
        });
    }
